...
<br>
<center><h1 style="font-size:80px;">Top Artisans</h1></center>
<div class="leaderboard" style="width:100%">
  ...
  <ol>
    <?php
    $user1='Artist';
   // echo "<a href='artistprofile.php?data123=$row[user_nick]'>";
    $sql="SELECT * FROM  top100 t,user_register u   where u.user_nick=t.user_nick and u.user_type='Artist' order by t.loyalty_pts DESC";
  
  
  $result=mysqli_query($db,$sql);
    while ($row = mysqli_fetch_array($result) ){
      echo"
    <center><a href='artistprofile.php?data123=$row[user_nick]'><li>
      <mark style='font-weight:bold'>$row[user_nick]</mark>
      <small style='font-weight:bold' >$row[loyalty_pts]</small>
    </li></a></center>";
    }
    ?>
    </ol>
