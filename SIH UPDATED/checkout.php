...
<div class="row">
    <div class="col-75">
        <div class="container">
            <!-- <form role="Form" method="POST" action="checkout2.php?variable3=<?php echo $name;?>" enctype='mutlipart/form-data'> -->

            <div class="row">
                    <div class="col-50">
                        <h3>Billing Address</h3>
                        <form method="POST" action="checkout2.php?variable4=<?php echo $name;?>" enctype='mutlipart/form-data'>
                    ...
                    <div class="col-50">
                        ...
                        <label >   <input type = "radio"
                                          ...
                                          id = "sizeSmall"
                                          value = "small"
                                          checked = "checked" />Cash On Delivery</label>
    ...
    <div class="col-25">
        <div class="container">
            <h4>Cart <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> <b>4</b></span></h4>
                <p><?php echo $name;?><span class="price"></span></p>
            <p><?php echo $cost;?><span class="price"></span></p>
            <p><?php echo $category;?></a> <span class="price"></span></p>
