...
<center><h1 style="font-size:50px;">Our Products</h1></center>
...
$s= mysqli_query($db,"SELECT product_cost,product_name,location,product_category FROM image WHERE product_category=$data");
