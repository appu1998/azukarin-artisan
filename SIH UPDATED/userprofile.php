...
<div id='cssmenu' style='position:fixed'  id="head">
    <div class="company-logo" >
        <h1 class="bg-dark text-light">Shilpakar</h1>
    </div>
    <ul>

        <li><a href='test.php' id="e">Home</a></li>
        <li><a href='#a' id="a">Your Profile</a></li>
        <li><a href='#b' id="b">CART</a></li>
        <li><a href='#c' id="c">Your Orders</a></li>
...
$s= mysqli_query($db,"SELECT i.product_cost,i.product_name,i.location,i.product_category FROM image i,`order` o WHERE o.product_name=i.product_name AND o.user_name='amir'
 ");
$num_rows1= mysqli_num_rows($s);
...
<table id='users' style=\"z-index:-1;\">
        <tr>
            <th>
                <a href='productcopy.php?data=$row[product_name]'>
                    <img  class = 'img1' src='" . $row['location'] . "'>
                </a>
            </th>
        </tr>
