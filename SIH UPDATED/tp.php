...
<div id='cssmenu' style='position:fixed'>
    <div class="company-logo"  >
        <h1 class="bg-dark text-light fixed-top"> Shilpakar</h1>
    </div>
    <ul>
...
<div>
    ...
    <div id="12">
        ...
        ?>
        <div id = "details" style=" position:relative;z-index:-1; text-align: justify;max-width:500px;  font-size: 16px; font-family: Helvetica ;font-weight:bold;">
            <br>
            <br> <div >    <img src="abcd.jpg" style="width: 300px;height: 300px;position: relative;"></div>
            <br>
            <br>
     <div >       <?php
...
<div id="123">
        ...
        <div id="column2" class="column2">
            <form name="form" action="tpdb.php" method="POST" id="form1" enctype="multipart/form-data">
                ...
                <select id="states" class="form-control" name="product_category">
                    ...
                    <option value="SAREE"> WOODEN ART</option>
                    <option value="GLASSART">SAREE</option>
                    <option value="JEWELERY">Jewelery</option>
                    <option value="HOMEPRODUCTS">CRAFT ITEMS</option>
                ...
                <br>
                <input type="file" name="foto1"  onchange="readURL(this)"  style="position:relative; right :480px; top: 200px;  ";>
                <br>
                Product cost:<br>        <br>
    ...
    <a href="rawmaterials.html">PURCHASE</a>
    <div id="4" >
        <?php
        $db = mysqli_connect('localhost', 'root', '', 'sih');
